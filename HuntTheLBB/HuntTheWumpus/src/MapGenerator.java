...
public class MapGenerator {
	...
	public Map generateStaticMap() {
		...
		connect(0, 1, Direction.SOUTH.getDirection());
		connect(1, 2, Direction.EAST.getDirection());
		connect(2, 3, Direction.EAST.getDirection());
		connect(3, 4, Direction.EAST.getDirection());
		connect(3, 5, Direction.SOUTH.getDirection());
		connect(5, 6, Direction.SOUTH.getDirection());
		connect(6, 7, Direction.SOUTH.getDirection());
		connect(6, 8, Direction.EAST.getDirection());
		connect(8, 9, Direction.EAST.getDirection());
		connect(6, 10, Direction.WEST.getDirection());
		connect(10, 11, Direction.WEST.getDirection());
		connect(11, 12, Direction.NORTH.getDirection());
		
		connect(1, 0, Direction.NORTH.getDirection());
		connect(2, 1, Direction.WEST.getDirection());
		connect(3, 2, Direction.WEST.getDirection());
		connect(4, 3, Direction.WEST.getDirection());
		connect(5, 3, Direction.NORTH.getDirection());
		connect(6, 5, Direction.NORTH.getDirection());
		connect(7, 6, Direction.NORTH.getDirection());
		connect(8, 6, Direction.WEST.getDirection());
		connect(9, 8, Direction.WEST.getDirection());
		connect(10, 6, Direction.EAST.getDirection());
		connect(11, 10, Direction.EAST.getDirection());
		connect(12, 11, Direction.SOUTH.getDirection());
